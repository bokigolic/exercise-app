...
/* ===== Content (12) with tags & quiz ===== */
const SECTIONS = [
  {
    id: "intro",
    icon: "book",
    title: "Introduction to Muscles",
    preview: "Muscles power all movement and protect health.",
    tags: ["basics", "health"],
    body: [
      "Muscles make up roughly 30–40% of body weight and are essential for movement, posture, breathing, circulation, and thermoregulation.",
      "They are living tissues that adapt to training, nutrition, and rest—improving performance and metabolic health.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Cardiac — involuntary, unique to the heart; pumps blood continuously.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Sarcomere → actin & myosin filaments slide to contract.",
      "Connective tissue: endomysium, perimysium, epimysium.",
      "Neuromuscular junctions: nerves stimulate contraction.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    body: [
      "Hypertrophy is triggered by microtears during resistance training and repaired via protein synthesis.",
      "Progressive overload (more weight/reps over time) and adequate recovery drive growth, supported by hormones like testosterone, GH, and IGF-1.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    tags: ["health", "aging"],
    body: [
      "Atrophy occurs with inactivity, illness, or malnutrition. Sarcopenia begins around 30 and accelerates after 50.",
      "Consequences: weakness, higher injury risk, and slower metabolism. Prevention: strength training + protein-rich diet.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    bullets: [
      "ATP: immediate fuel.",
      "Creatine phosphate: quick power bursts.",
      "Glycogen: primary during high-intensity work.",
      "Fatty acids: main fuel at rest/long duration.",
      "Protein: last-resort fuel when carbs/fats are low.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    bullets: [
      "Protein: ~1.6–2.2 g/kg/day for active individuals.",
      "Carbohydrates: refill glycogen for training performance.",
      "Healthy fats: support hormone balance.",
      "Micronutrients: vitamin D, calcium, magnesium, iron.",
  ...
  },
  {
    ...
    body: [
      "Rest days are essential; deep sleep (7–9 h) supports growth hormone release and tissue repair.",
      "Active recovery (walking, stretching, yoga) improves blood flow. Avoid overtraining by managing volume and using deloads.",
    ],
    quiz: [
      {
  ...
  },
  {
    ...
    tags: ["training"],
    bullets: [
      "Intensity: load/weight used.",
      "Volume: sets × reps (total work).",
      "Frequency: how often a muscle is trained.",
      "Variation: prevents plateaus.",
      "Consistency: long-term gains require time.",
    ],
    quiz: [
      {
        q: "Volume equals…",
  ...
  },
  {
    ...
    preview: "From growth in youth to decline in age.",
    tags: ["aging", "health"],
    bullets: [
      "Childhood/teens: natural growth with activity & hormones.",
      "20s: peak muscle mass potential.",
      "30–40s: gradual decline without training.",
      "50+: sarcopenia accelerates; lift + protein matter more.",
      "70+: training preserves mobility & independence.",
    ],
    quiz: [
  ...
  },
  {
    ...
    icon: "star",
    title: "Fun Facts",
    preview: "Jaw is the strongest muscle for its size.",
    tags: ["fun"],
    bullets: [
      "Largest: gluteus maximus.",
      "Strongest relative to size: masseter (jaw).",
      "600+ muscles coordinate daily actions.",
      "Standing still requires hundreds of contractions.",
    ],
    quiz: [
      {
        q: "Largest muscle is…",
  ...
  },
  {
    ...
    tags: ["summary"],
    bullets: [
      "Growth = training + nutrition + recovery.",
      "Inactivity causes fast decline.",
      "Muscles support strength, health, mobility, and energy.",
    ],
    quiz: [
      {
...
function Card({ section, onOpen, isFav, toggleFav }) {
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -2 }}
      transition={{ type: "spring", stiffness: 300, damping: 24 }}
      className="relative rounded-2xl p-4 bg-white/80 shadow-sm ring-1 ring-slate-900/10 hover:shadow-lg dark:bg-slate-900/70 dark:ring-white/10"
    >
      ...
      <div className="mt-3 flex items-center justify-between">
        <button
          ...
          className="text-xs px-2.5 py-1.5 rounded-lg bg-slate-900 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
        >
          Read more
        </button>
        <button
    ...
    >
      <motion.div
        ...
        className={cn(
          ...
          "w-full sm:w-[680px] max-w-screen px-4 sm:px-0"
        )}
      >
        <motion.div
          ...
          className="rounded-2xl bg-white text-slate-900 shadow-2xl ring-1 ring-slate-900/10 dark:bg-slate-900 dark:text-slate-100 dark:ring-white/10 overflow-hidden"
        >
          {/* Progress bar */}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-2 flex gap-2 text-xs">
                ...
                <button
                  ...
                  className="px-2 py-1 rounded bg-white/10 hover:bg-white/20 dark:bg-white/10"
                >
                  Quiz
                </button>
              </div>
                ...
                <div className="mt-3 rounded-xl bg-blue-50 text-blue-900 ring-1 ring-blue-200 dark:bg-blue-950/40 dark:text-blue-200 dark:ring-blue-900/40 p-3">
                  ...
                  <ul className="mt-1 text-sm list-disc list-inside space-y-1">
                    {section.id === "nutrition" && (
                      <li>
                        Target protein: <strong>1.6–2.2 g/kg/day</strong>.
                      </li>
                    )}
                    {section.id === "hypertrophy" && (
                      <li>
                        Progressive overload: add reps/weight or slow tempo
                        weekly.
                      </li>
                    )}
                    {section.id === "recovery" && (
                    ...
                    {section.id === "fuel" && (
                      <li>
                        Creatine monohydrate: 3–5 g/day can support
                        high-intensity work.
                      </li>
                    )}
                    {section.id === "training" && (
                      <li>
                        ...
                        <em>frequency</em> for each muscle.
                      </li>
                    )}
                  </ul>
                </div>
...
function Quiz({ sectionId, items }) {
  ...
  return (
    <div className="rounded-xl bg-white/60 dark:bg-white/5 ring-1 ring-slate-200 dark:ring-white/10 p-3">
